import { SNACaseStudy, SNADecisionNode } from '../schemas';

export const SNA_DECISION_NODES: Record<string, SNADecisionNode> = {
  root: {
    id: 'root',
...
export const SNA_CASE_STUDIES: SNACaseStudy[] = [
  {
    id: 'CS01',
