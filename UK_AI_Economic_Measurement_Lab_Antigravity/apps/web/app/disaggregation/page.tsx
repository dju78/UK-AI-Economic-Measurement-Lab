        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-100">
          <div>
            ...
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight flex items-center gap-2.5">
              <Sliders className="w-5 h-5 text-slate-800 stroke-[1.75]" />
          ...
          <div className="flex items-center gap-2 self-start">
            <button
              ...
              className="px-3.5 py-2 bg-slate-900 text-white rounded text-xs font-semibold hover:bg-slate-800 transition-colors flex items-center gap-1.5 shadow-xs"
            >
              <Download className="w-3.5 h-3.5 stroke-[1.75]" /> Export Scenario JSON
            </button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-xs space-y-5">
            <div className="pb-3 border-b border-slate-100 flex items-center justify-between">
              ...
              >
                <RotateCcw className="w-3 h-3 stroke-[1.75]" /> Reset
              </button>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full py-2 px-3 bg-slate-50 border border-slate-200 rounded-lg text-xs font-medium text-slate-900 focus:ring-2 focus:ring-slate-900"
              >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full py-2 px-2.5 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-900 focus:ring-2 focus:ring-slate-900"
                >
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full py-2 px-2.5 bg-slate-50 border border-slate-200 rounded-lg text-xs font-mono font-semibold text-slate-900 focus:ring-2 focus:ring-slate-900"
                >
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-xs font-semibold mb-1 text-slate-800">
                      ...
                      <span className="font-mono text-slate-900 font-bold">{formatPercent(shareBase * 100, 1)}</span>
                    </div>
                    <input
                      type="range"
                      min="0.01"
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded-xl border-2 border-slate-900 p-5 shadow-xs">
              ...
              <span className="text-[11px] font-semibold text-slate-700 mt-1.5 block">
