...
export default function SourcesPage() {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="bg-white border border-slate-200/90 rounded-xl p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="relative w-full sm:w-96">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-slate-50/70 border border-slate-200 rounded-lg text-xs focus:ring-1 focus:ring-slate-900 focus:outline-none"
          />
        </div>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <select
            ...
            className="py-2 px-3 bg-slate-50/70 border border-slate-200 rounded-lg text-xs font-medium text-slate-700 focus:ring-1 focus:ring-slate-900 focus:outline-none"
          >
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-slate-100">
              {filteredSources.map((source) => (
                ...
                >
                  <td className="p-3.5 font-bold font-mono text-slate-900">{source.id}</td>
                  ...
                  <td className="p-3.5 text-right">
                    ...
                    >
                      Source <ExternalLink className="w-3 h-3 text-slate-400" />
                    </a>
                  </td>
                </tr>
              ))}
