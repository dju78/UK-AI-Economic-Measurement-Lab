...
# 4. ONS Data Centres & Digital Infrastructure (DS04 & DS05 / S3 & S4)
infra_data = {
    "source_id": "DS04",
...
# 5. AI Business Classification Demo & Evaluation Corpus (60 realistic UK businesses)
# Covers dedicated AI, diversified software, hard negatives, and non-AI across multiple sectors
business_corpus = [
    {
    ...
    },
    {
        ...
        "ground_truth_labels": ["ai_consulting_adoption"],
    ...
    {
        "business_id": "UK-AI-0013",
        "company_name": "NorthStar Logistics & Haulage Ltd",
        "sic_code": "49.41",
        "sic_description": "Freight transport by road",
        "text": "National road freight, warehousing, and refrigerated logistics across the UK. We operate an modern fleet of Euro 6 trucks with GPS telematics tracking.",
        "ground_truth_labels": [],
        "ground_truth_ai_relevant": False,
        "ground_truth_dedicated": False,
        "is_hard_negative": False
    ...
    {
        "business_id": "UK-AI-0019",
        "company_name": "BrightSpark Cleaners Ltd",
        "sic_code": "81.21",
...
print(f"Data layer built successfully. Manifest written to {MANIFEST_PATH}")
